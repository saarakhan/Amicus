  ...
  return (
    <>
      <nav className="mx-auto bg-white border-b border-gray-300 shadow-sm py-4 px-14 flex items-center justify-between sticky top-0 z-10">
        <div className="text-2xl font-Mozilla font-bold text-[#302f2d] cursor-pointer">Amicus</div>
        ...
        <div className="flex items-center space-x-3 text-gray-500 text-xl">
          ...
          <div className="p-2 rounded-md hover:bg-gray-200 hover:scale-110 transition-all duration-300 cursor-pointer ">
            <BiGhost
              className="text-xl"
              onClick={() => {
